...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pxd3rpm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pxd3rpm.containers.anotherwebservice.com/
...
```
git clone git@github.com:atomperson/container-pxd3rpm.git
cd container-pxd3rpm
```
...
```
docker attach container-pxd3rpm
```
